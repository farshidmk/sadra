...
type TInputTypes = "text" | "autocomplete" | "checkbox" | "select" | "date" | "password" | "city" | "custom";
...
interface ICustomInput extends IBaseInput<"custom"> {
  render: React.ReactElement;
}

export type IRenderInput = IText | ISelect | IAutocomplete | ICheckbox | IDate | ICitySelect | IBoolean | ICustomInput;
